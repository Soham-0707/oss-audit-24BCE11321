...
| Field | Details |
|-------|---------|
| **Student Name** | Soham Jain |
| **Registration Number** | 24BCE11321 |
...
```bash
git clone https://github.com/[your-username]/oss-audit-24BCE11321.git
cd oss-audit-24BCE11321
```
